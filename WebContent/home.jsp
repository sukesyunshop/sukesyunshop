...
<body>
	...
	<div id="header">
		...
		<table>
			...
			<s:form action="SearchAction">
				<tr>
					<td><input type="search" name="searchText"
		...
		<ul class="category">
			<s:iterator value="cateList">
				<li><a
					href="<s:url action='SearchAction'><s:param name="categoryId" value="getCategoryId()"/></s:url>"><s:property
							value="getCategoryName()" /></a></li>
			</s:iterator>
		</ul>
	</div>
	<!------------ヘッダーここまで ------------>
	...
	<div class="item">
		<div>
			<a href="<s:url action="ProductDetailAction" />"><img
				src="./public/1.jpg"></a>
		</div>
		<div>
			<a href="<s:url action="ProductDetailAction" />"><img
