		...
		<s:iterator value="cartList">
			<table border=1>
				...
				<tr>
					...
					<td><s:property value="getProductName()" /> <img
						src="<s:property value="getImageFilePath()"/>" class="itemImage"></td>
					<td><s:property value="getPrice()" />円</td>
					<td><s:property value="getReleaseCompany()" /></td>
					<td><s:property value="getReleaseDate()" /></td>
					<td><a class="delete"
						href="<s:url action="CartDeleteAction"><s:param name="productId" value="getProductId()" /></s:url>">削除</a></td>
			</table>
		</s:iterator>
