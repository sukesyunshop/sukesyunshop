		...
		<s:form method="post" action="BuyItemCompleteAction">
			<div class="destList">
				<s:iterator value="destDTOList" status="list">
					...
					<label for="<s:property value="#list.index"/>">
						名前：<s:property value="getFamilyName()" escape="false" /> <s:property value="getFirstName()" escape="false" />
						<br> ふりがな：<s:property value="getFamilyNameKana()" escape="false" /> <s:property value="getFirstNameKana()" escape="false" />
						<br> アドレス：<s:property value="getEmail()" escape="false" />
						<br> 連絡先：<s:property value="getTelNumber()" escape="false" />
						<br> 送り先：<s:property value="getUserAddress()" escape="false" />
					</label>
				</s:iterator>
			</div>
			...
			<ul class="cartList">
				<s:iterator value="cartList">
					<li class="cartItem"><img class="itemImage" alt="image" src="<s:property value="getImageFilePath()" />">
